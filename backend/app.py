...
def create_app(config_name='default'):
    ...
    def demo_auth():
        ...
        demo_name = "Demo User"
        session_id = voter_session.create_session(demo_user_id, demo_email, demo_name, has_voted=False, is_admin=False, is_eligible_voter=False) # Demo user is not admin or eligible
        session['voter_session_id'] = session_id
        ...
        return jsonify({
            ...
            'user': {
                ...
                'isEligibleVoter': False # Demo user is not an eligible voter
            }
        }), 200
    ...
    # --- ELECTION DATA ROUTES (Mostly unchanged, key parts highlighted) ---
    ...
    def get_results():
        try:
            ...
            return jsonify({
                'isOpen': status.is_open, # Use the correct attribute name
    ...
    def get_election_status_api():
        try:
            ...
            return jsonify({'is_open': status.is_open}), 200
        except Exception as e:
