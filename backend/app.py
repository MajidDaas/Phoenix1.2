...
def create_app(config_name='default'):
    ...
    def demo_auth():
        ...
        session_id = voter_session.create_session(demo_user_id, demo_email, demo_name, has_voted=False, is_admin=False, is_eligible_voter=False) # Assuming demo user IS admin/eligible for testing UI
        session['voter_session_id'] = session_id
        ...
        return jsonify({
            ...
            'user': {
                ...
                'isEligibleVoter': False, # Corrected: Demo user is eligible for testing voting UI
                'hasVoted': False
            }
        }), 200
